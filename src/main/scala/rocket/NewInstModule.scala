...
class MulDiv(cfg: NewInstParams, width: Int/*, nXpr: Int = 32*/) extends Module {
  val io = new NewInstrIO(width/*, log2Up(nXpr)*/)
  ...
  val s_ready :: s_inputs :: s_add :: s_done :: Nil = Enum(UInt(), 4)
